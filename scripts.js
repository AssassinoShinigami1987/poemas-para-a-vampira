...
const poemas = [
  ...
  {
    titulo: "Promessa de Maçã",
    texto: [
      'Ceifador trevoso, de manto arrastando,',
      'no canto da noite, já vai digitando.',
      'Mensagem vai, notificação vem,',
      'com uma vampira, trevosa também.',
      '',
      '"Boa noite, docinho de piche e veludo."',
      'Ela responde: "Ceifador, seu safado, seu bruto!"',
      'Trocam emojis, caveiras, corações,',
      'muito dark, mas cheios de intenções.',
      '',
      'Ela diz: "Vem logo, tô cheia de sede."',
      'Ele responde: "Calma, bebê, me concede."',
      '"Prometo que hoje eu te como, garota,',
      'como se fosse uma torta de maçã bem crocanta."',
      '',
      'Ela ri: "Vai sonhando, sombrio sem noção."',
      'Ele diz: "Te amasso com foice e paixão."',
      'Combinaram no app, marcaram rolê,',
      'num cemitério gótico, só pra se ver.',
      '',
      'Ela chegou com batom escuríssimo,',
      'ele de capuz, com olhar perigosíssimo.',
      'Ela falou: "Cadê a torta que prometeu?"',
      'Ele sorriu: "Tá aqui ó... e sou eu!"',
      '',
      'Beijaram-se forte, entre lápide e flor,',
      'em cada mordida, sentiam o sabor.',
      'Ela chupava, ele tremia,',
      'não sabia se era medo ou alegria.',
      '',
      'No fim da noite, a lua brilhou,',
      'a torta sumiu, o ceifador dançou.',
      'E desde então, nos grupos da treva,',
      'rola print safado que ninguém releva.'
    ],
    tema: {
      fundo: "#f8f5e9",
      texto: "#3e2c1c",
  ...
  {
    titulo: "Abismo com Gato",
    texto: [
      'Num canto esquecido, sem Wi-Fi, sem sinal,',
      'vive um ceifador nada normal.',
      'Negro, calado, com gosto sombrio,',
      'adora o silêncio, o vazio, o frio.',
      '',
      'Mas não está só, não pense assim,',
      'tem sua gata, que é puro cetim.',
      'Preta, malvada, com olhos de brasa,',
      'anda com ele e dorme em sua asa.',
      '',
      'No abismo mais fundo, sem luz, sem calor,',
      'ele faz carinho enquanto sente amor.',
      '"Só nós dois, gatinha, aqui nesse vão."',
      'Ela responde com um miado: "Miau do coração."',
      '',
      'Juntos veem estrelas que ninguém vê,',
      'ouvem o eco do nada como se fosse TV.',
      'Ele lê poesia com voz de trovão,',
      'ela ronrona e vira um colchão.',
      '',
      'Às vezes jogam Uno, às vezes dominó,',
      'mas ela sempre vence, o ceifador é um zó.',
      '"Trapaceia, safada!" ele diz com humor,',
      'e ela sorri lambendo a própria flor.',
      '',
      'Ali não tem drama, nem alma, nem gente,',
      'só o som do abismo e um lar diferente.',
      'Um lar feito de trevas e pelúcia felina,',
      'com o ceifador e sua gata assassina.'
    ],
    tema: {
      fundo: "#f8f5e9",
      texto: "#3e2c1c",
  ...
  {
    titulo: "Sol é Inimigo, Chuva é Canção",
    texto: [
      'Ceifador de capa, vampira de véu,',
      'os dois de trevas, fugindo do céu.',
      'Sol pra eles é tipo maldição,',
      'mas na chuva... ah, bate emoção.',
      '',
      'Caía água como lágrima punk,',
      'os dois dançando, um gótico funk.',
      'Manto molhado, dente pingando,',
      'ninguém entendia, mas estavam amando.',
      '',
      '"Você viu? Trovão!" ela grita animada.',
      '"É meu ringtone," ele ri, "que entrada!"',
      'Riem da morte, correm na lama,',
      'ela sem batom, ele com chama.',
      '',
      'Mas quando o sol aparece atrevido,',
      'correm pra sombra num pulo contido.',
      'Ela grita: "Cadê o céu nublado?"',
      'Ele responde: "Pedi pra Deus, foi ignorado."',
      '',
      'Se escondem em túmulo, embaixo do banco,',
      'no guarda-chuva de um mendigo manco.',
      'Pagam com sangue e um beijo discreto,',
      'e o velhinho diz: "Que casal mais esquisito e correto."',
      '',
      'Vivem de nuvem, garoa, trovão,',
      'o sol pra eles é tipo prisão.',
      'Mas juntos, na chuva, são fogo e carvão,',
      'góticos molhados em eterna paixão.'
    ],
    tema: {
      fundo: "#f8f5e9",
      texto: "#3e2c1c",
  ...
  {
    titulo: "Cabelos de Treva, Amor em Camadas",
    texto: [
      'O ceifador andava no breu da calçada,',
      'de foice em punho e alma cansada.',
      'Mas bastava um "ping!" no celular,',
      'que a noite ganhava um novo brilhar.',
      '',
      'Era ela, a vampira de olhar penetrante,',
      'gótica, trevosa, de humor flutuante.',
      'Mas o que deixava o ceifador bobo,',
      'era o cabelo dela... sempre um novo lobo.',
      '',
      'Um dia de preto, liso e mortal,',
      'no outro, vermelho, estilo infernal.',
      'Depois roxo escuro, quase abissal,',
      'e um verde esmeralda? Quase ilegal!',
      '',
      '"Você muda mais que alma penada",',
      'ele dizia, com voz encantada.',
      'E ela sorria, girando no ar,',
      'como se o salão fosse seu altar.',
      '',
      'Teve trança com espinho, coque com cruz,',
      'até dread com arame, estilo de luz.',
      'Ele falava: "Hoje tá de terror francês!"',
      'E ela piscava: "Amanhã invento outra vez."',
      '',
      'Certa vez, chegou careca e linda,',
      'com tatuagem de morcego na guinda.',
      'O ceifador caiu de joelhos no chão,',
      '"Case comigo, ou me arranque o coração!"',
      '',
      'Ela riu, soprando fumaça de chá,',
      '"Só se você pintar a barba de lilá."',
      'Ele topou, pintou e dançou,',
      'e a morte naquela noite até se atrasou.',
      '',
      'Porque entre um enterro e uma ressurreição,',
      'ele espiava ela em cada transformação.',
      'E dizia com brilho, no fundo da alma:',
      '"Cada cabelo seu é mais uma arma."',
      '',
      'Uma arma que corta, que encanta, que ferve,',
      'mais mortal que foice, mais gostosa que cerveja.',
      'E assim ele vive, fiel e sem medo,',
      'amando sua musa — e cada novo cabelo.'
    ],
    tema: {
      fundo: "#f8f5e9",
      texto: "#3e2c1c",
  ...
  {
    titulo: "Flores Pretas e o Crush das Sombras",
    texto: [
      'Num bairro esquisito, com neblina e wi-fi ruim,',
      'passavam flores pretas de mão em mão, tipo motoboy sem fim.',
      'Não eram de plástico, nem de novela da Globo,',
      'eram flores sinistras, mais góticas que um corvo rouco no lobo.',
      '',
      'De tia fofoqueira a um emo perdido,',
      'as flores viajavam como link de vídeo proibido.',
      'Diziam que quem recebia aquele buquê mal-assombrado',
      'tinha um crush escondido ou tava emocionalmente bugado.',
      '',
      'Cada flor era tipo uma senha secreta,',
      'um cupido sombrio com alma de treta.',
      'Até que um dia, plim, chegou na mão do menino João,',
      'que usava all star rasgado e tinha playlist só com refrão.',
      '',
      'João era romântico, mas do tipo confuso,',
      'que chora com meme triste e manda coração até pro impulso.',
      'Mas quando viu a flor, sentiu aquele "pá!" no peito,',
      'como se o Spotify tivesse lido seu defeito.',
      '',
      '"Isso aqui é sinal!", ele pensou com coragem,',
      'e saiu em busca dela, a rainha da maquiagem.',
      'Garota trevosa, que curtia cemitério e banda sueca,',
      'esperava há anos seu romântico da discoteca.',
      '',
      'Ela tinha olhos que pareciam saber de tudo,',
      'inclusive onde ele perdeu o fone no escuro.',
      'O cabelo? Preto com mechas de eclipse total,',
      'a risada? Sarcástica, mas com toque emocional.',
      '',
      'Ela o esperava — sim, com paciência de freira ninja —',
      'porque acreditava no amor, mesmo com alma esquisita e fringida.',
      'Já tinha mandado sinais: stories com indireta,',
      'playlist depressiva e até emoji de borboleta.',
      '',
      'Mas João, coitado, só notava agora,',
      'quando a flor chegou igual boleto na hora.',
      'Ele correu até ela com o buquê na mão,',
      'mais nervoso que Wi-Fi em reunião.',
      '',
      '"Isso aqui é pra você!", ele disse tremendo,',
      'e ela riu tipo vilã de anime, fingindo.',
      'Mas por dentro pensava: "Finalmente, o bobo entendeu!",',
      'e o universo deu um print, porque o amor aconteceu.',
      '',
      'As flores pretas não murcharam, só deram risada,',
      'porque sabiam que a treva também ama, de forma pesada.',
      'E ali, no meio da praça com eco de gralha,',
      'rolou o beijo mais estranho desde Crepúsculo na batalha.',
      '',
      'Moral da história? Até flor do submundo tem missão,',
      'e o amor chega sim — mesmo que vindo na contra-mão.',
      'Então se a vida te der uma flor meio trevosa,',
      'cheira com fé, porque o romance vem na hora mais estranha e perigosa.'
    ],
    tema: {
      fundo: "#f8f5e9",
      texto: "#3e2c1c",
  ...
  {
    titulo: "Alianças e o Silêncio em Alto e Bom Som",
    texto: [
      'Num fundo de gaveta mística, meio poeirenta,',
      'morava um par de alianças com fama nada modesta.',
      'Diziam que, no dedo certo, grudava mais que cola,',
      'união de alma nível Wi-Fi que nunca descola.',
      '',
      'Eram feitas de prata com pitadas de feitiço,',
      'deixavam até casal briga-feia no maior compromisso.',
      'Mas claro, não eram pra qualquer mão ou qualquer crush,',
      'só funcionavam com gente que amava de verdade, no hush hush.',
      '',
      'Rodaram bolsos, caixas, bazar de vó medium,',
      'mas sempre escapavam dos dedos do público stadium.',
      'Até que um dia, plim, com trilha sonora de novela,',
      'caíram na mochila de um garoto que escutava mais que a Alexa.',
      '',
      'O nome dele? José, mas podia ser "Fone Humano",',
      'ouvia tanto os outros que até o vento achava insano.',
      'De conselhos vivia, de segredos era cofre,',
      'sabia da vida alheia mais que juiz de The Voice.',
      '',
      'Só que o coração dele? Vazio que nem sala de Zoom em feriado,',
      'até conhecer ela: Nati, a rainha do "tô bem, só cansada mesmo", com olhar fechado.',
      '',
      'Nati não falava muito, era mais emoji do que frase,',
      'tímida, calada, com vibes de quem sempre se atrasa.',
      'Mas quando olhava, era tipo spoiler: dizia tudo sem dizer nada,',
      'e José, o ouvinte, percebeu que ali tinha uma alma encantada.',
      '',
      'Os dois não eram clichê, nem casal de TikTok,',
      'mas quando ficaram perto, o mundo parecia dar lock.',
      'Ela falava com o olhar, e ele respondia com sorriso,',
      'como se fossem dois fones com Bluetooth preciso.',
      '',
      'Um dia, do nada, o par de alianças caiu no chão,',
      'rolou até eles igual cena de filme com drone e canção.',
      'José pegou, pensou "ué, será que encaixa?"',
      'Nati deu um meio sorriso, daquele que disfarça.',
      '',
      'Ele colocou no dedo dela com cuidado de quem instala update,',
      'e no mesmo segundo, bum!, conexão direta, sem debate.',
      'Não era magia de conto brega nem truque de roteiro,',
      'era só o destino dizendo: "Deu match, companheiro!"',
      '',
      'Ela, que falava pouco, sentiu o peito explodir em verso,',
      'e ele, que ouvia tudo, entendeu cada silêncio do universo.',
      'As alianças brilharam, tipo LED com emoção,',
      'porque sabiam: finalmente acharam a combinação.',
      '',
      'Desde então, não precisavam de legenda nem dublagem,',
      'viviam de olhares, toques e uma vibe de viagem.',
      'O povo perguntava: "Como eles se entendem?"',
      'E a resposta era clara: "Ela cala, ele compreende."',
      '',
      'Moral da fita? Nem todo amor grita feito sirene,',
      'às vezes ele sussurra, mas vale por um hino que não treme.',
      'E se um par de alianças cair na sua mão sem aviso,',
      'ouve bem o silêncio — ele pode ser o maior grito do paraíso.'
    ],
    tema: {
      fundo: "#f8f5e9",
      texto: "#3e2c1c",
  ...
  {
    titulo: "De Mãos Dadas e Memes Criminais",
    texto: [
      'Era um dia comum, tipo terça sem promoção,',
      'quando dois seres cruzaram caminho sem direção.',
      'Ela vinha com olhar de "tô pronta pra sumir",',
      'ele com camiseta do Batman e jeito de quem ia fugir.',
      '',
      'Mas quando as mãos se tocaram, plim, rolou energia,',
      'tipo quando a tomada encaixa sem faísca, só sintonia.',
      'Nada de fogo de palha, nem cupido com mira torta,',
      'era só um aperto de mão... mas que abriu outra porta.',
      '',
      'Daquele toque saiu faísca, não elétrica — emocional,',
      'o tipo de conexão que faz até terapeuta falar "uau, que casal".',
      'As mãos dadas deles? Um Wi-Fi revolucionário,',
      'que mudava o mundo deles num bug temporário.',
      '',
      'Ela tinha sarcasmo no olhar e riso de vilã de série,',
      'ele mandava piada ruim até no enterro do padre.',
      'Tipo:',
      '— "Se a gente fugir junto, é sequestro ou romance?"',
      '— "Depende… vai ter lanche?"',
      'E riam. Deus sabe por quê. Mas riam.',
      '',
      'A cada piada, uma ideia ilegal brotava:',
      '"Vamos roubar um pôr do sol?",',
      '"Ou sequestrar um sábado e nunca mais devolver pra semana brava?"',
      'Falavam de fugir pra um país fictício,',
      'onde só existisse feriado, meme e serviço fictício.',
      '',
      'Todo mundo em volta dizia: "Esse casal é perigoso!"',
      'Mas não por armas, só por serem ridiculamente corajosos.',
      'De mudar tudo com um toque, um olhar cúmplice,',
      'e transformar tédio em roteiro de série que ninguém transmite.',
      '',
      'As mãos deles, quando unidas, criavam caos positivo,',
      'tipo dois cometas colidindo no horóscopo afetivo.',
      'Mudavam o mundo só com presença e piada ruim,',
      'como quem derruba sistema só rindo do fim.',
      '',
      'E no fundo, sabiam: estavam prestes a cometer um crime,',
      'não desses de cadeia, mas de deixar a rotina sem rime.',
      'Iam sabotar a lógica, o plano, o normal,',
      'e fugir pela saída de emergência emocional.',
      '',
      'Porque amor, às vezes, é isso:',
      'um toque de loucura e zero compromisso com o script da novela.',
      'É segurar a mão errada — mas que te leva pra vida certa,',
      'mesmo que o plano seja ruim e a rota esteja incerta.',
      '',
      'Moral da história? Cuidado com a mão que você pega no meio do dia,',
      'ela pode te fazer rir, fugir, e transformar rotina em anarquia.',
      'E se vier com piada ruim junto, segura firme, irmão:',
      'porque talvez essa seja a sua melhor decisão.'
    ],
    tema: {
      fundo: "#f8f5e9",
      texto: "#3e2c1c",
...
const botaoFecharModalNoturno = document.getElementById('fechar-modal');
const botaoFavoritar = document.getElementById('favoritar-poema');

// Funções de favoritos
let poemasFavoritos = JSON.parse(localStorage.getItem('poemasFavoritos')) || [];

function salvarFavoritos() {
  localStorage.setItem('poemasFavoritos', JSON.stringify(poemasFavoritos));
}

function isFavorito(index) {
  return poemasFavoritos.includes(index);
}

function toggleFavorito() {
  const indexAtual = poemaAtual;
  if (isFavorito(indexAtual)) {
    poemasFavoritos = poemasFavoritos.filter(index => index !== indexAtual);
    botaoFavoritar.textContent = '⭐';
    botaoFavoritar.title = 'Adicionar aos favoritos';
  } else {
    poemasFavoritos.push(indexAtual);
    botaoFavoritar.textContent = '🌟';
    botaoFavoritar.title = 'Remover dos favoritos';
  }
  salvarFavoritos();
}

function atualizarBotaoFavorito() {
  if (isFavorito(poemaAtual)) {
    botaoFavoritar.textContent = '🌟';
    botaoFavoritar.title = 'Remover dos favoritos';
  } else {
    botaoFavoritar.textContent = '⭐';
...
function aplicarTema(tema) {
  // As variáveis de cor globais (cor-fundo, cor-texto, etc.) são agora controladas exclusivamente pelo CSS
  // e a classe body.modo-noturno, não sendo mais sobrescritas aqui.

  // Remove efeitos de brilho ou outras propriedades dinâmicas do texto se existirem
  const textos = document.querySelectorAll('.texto-poema, .titulo-poema');
  textos.forEach(texto => {
    texto.style.textShadow = ''; // Limpa o text-shadow para ser controlado pelo CSS
  });

  // Limpa estilos de partículas ou outras propriedades dinâmicas
...
botaoFavoritar.addEventListener('click', toggleFavorito);
...
function criarSeletorPoemas() {
  ...
  poemas.forEach((poema, index) => {
    ...
    if (isFavorito(index)) {
      item.classList.add('poema-item-favorito');
    }
    item.innerHTML = `
      <h4>${poema.titulo} ${isFavorito(index) ? '<span class="estrela-favorito">🌟</span>' : ''}</h4>
    `;
